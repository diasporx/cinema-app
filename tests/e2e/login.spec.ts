...
test('должен показать ошибку для некорректных учетных данных', async ({ page }) => {
  ...
  await expect(page.locator('text=Пароль должен содержать хотя бы одну заглавную букву')).toBeVisible()
})
